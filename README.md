...
- performance constants: `GAMEPLAY_STARFIELD_STRIDE`, `PLANET_LOD_FULL_DISTANCE`, `PLANET_LOD_SURFACE_DISTANCE`, `RESULT_CONFETTI_MAX_PARTICLES`, `CREW_CONFETTI_PARTICLES`, `DEMO_COMMAND_RECALC_FRAMES`
...
- Use DEBUG performance timings during manual play to tune prediction, planet drawing, objects, and result celebration costs.
